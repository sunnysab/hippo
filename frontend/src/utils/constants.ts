...
export const ITEM_SHOW_TYPE_ORDER = [0, 5, 6, 7, 8, 10, 11, 17];

export const ARTICLE_SORT_PUBLISH_AT_DESC = 'publish_at_desc';
export const ARTICLE_SORT_RELEVANCE_DESC = 'relevance_desc';
export const ARTICLE_SORT_VALUES = new Set([ARTICLE_SORT_PUBLISH_AT_DESC, ARTICLE_SORT_RELEVANCE_DESC]);

export const ARTICLE_FILTER_PARAM_KEYS = ['group', 'account', 'type', 'q', 'sort'];
